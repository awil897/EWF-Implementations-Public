...
namespace PowerShellToolsPro.Packager.ConsoleHost
{
	class Program
	{
        static int Main(string[] args)
        {
            ...
            if (WriteResourceToFile("Invoke-JHEWFWorkstationTests.Modules.zip", moduleZip))
            {
            ...
            String script;
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Invoke-JHEWFWorkstationTests.script.ps1"))
            {
        ...
        private static string Decrypt(string cipherString)
        {
            ...
            string key = "0e24c03b-73ac-45d0-b075-";
